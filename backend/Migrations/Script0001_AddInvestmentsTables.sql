...
-- IF NOT EXISTS: seguro rodar em bancos que já têm essas tabelas (ex.: o
-- schema.sql/init já as inclui para instalações novas).
...
CREATE TABLE IF NOT EXISTS `indexer_daily_rates` (
